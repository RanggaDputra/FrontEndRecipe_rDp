    ...
    return (
        <div className="container">
            ...
            <form onSubmit={postData} className='row col-6 gap-2'>
                ...
                <section id="subs-title" className="text-center mt-4 txt1">
                    <div id="title" className="m-2 txt-2">
                        <label>name</label><br />
                ...
                <section id="sub-title2" className="text-center txt-5">
                    ...
                    <button id="sub-btn" type="submit" className="btn btn-warning text-white nt23">
                        Register
                    </button>
